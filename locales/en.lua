Locales['en'] = {
  ...
  -- Weapon Components
  ['component_clip_default'] = 'Default Mag',
  ['component_clip_extended'] = 'Extended Mag',
  ['component_clip_drum'] = 'Drum Mag',
  ['component_clip_box'] = 'Clip Box',
  ['component_flashlight'] = 'Flashlight',
  ['component_scope'] = 'Scope',
  ['component_scope_advanced'] = 'Advanced Scope',
  ['component_suppressor'] = 'Suppressor',
  ['component_grip'] = 'Grip',
  ['component_luxary_finish'] = 'Skin',
  ['component_handguard'] = 'Handguard',
  ['component_stock'] = 'Stock',
  ['component_mag'] = 'Drum Mag',

  -- Weapon Tints
  ['tint_default'] = 'Default',
  ['tint_green'] = 'Green Tint',
  ['tint_gold'] = 'Gold Tint',
  ['tint_pink'] = 'Pink Tint',
  ['tint_army'] = 'Army Tint',
  ['tint_lspd'] = 'Police Tint',
  ['tint_orange'] = 'Orange Tint',
  ['tint_platinum'] = 'Platnium Tint',
}
