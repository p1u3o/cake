...
Config.Weapons = {
	------------------ AIRSOFT GUNS
	{
		...
		label = "Airsoft Glock",
		ammo = {label = 'BBs', hash = GetHashKey('AMMO_PISTOL')},
	...
	},
	{
		...
		label = "Airsoft MP5",
		ammo = {label = 'BBs', hash = GetHashKey('AMMO_SMG')},
		tints = Config.DefaultWeaponTints,
		components = {}
	},
	{
		...
		label = "Airsoft M4",
		ammo = {label = 'BBs', hash = GetHashKey('AMMO_RIFLE')},
		tints = Config.DefaultWeaponTints,
		components = {}
	},
	{
	...
	},
	{
		...
		label = "Airsoft R700",
		ammo = {label = 'BBs', hash = GetHashKey('AMMO_SNIPER')},
		tints = Config.DefaultWeaponTints,
		components = {}
	},
	{
	...
	{
		name = 'WEAPON_AIRSOFTUZIMICRO',
		label = "Airsoft Micro Uzi",
		ammo = {label = 'BBs', hash = GetHashKey('AMMO_SMG')},
		tints = Config.DefaultWeaponTints,
		components = {}
	},
	{
		...
		label = "Airsoft Shotgun",
		ammo = {label = 'BBs', hash = GetHashKey('AMMO_SHOTGUN')},
		tints = Config.DefaultWeaponTints,
		components = {}
	},
	------------------ Custom WEAPONS
	{
		...
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'sig_clip', label = _U('component_clip_default'), hash = GetHashKey('COMPONENT_SIG_CLIP_01')},
			{name = 'sig_extendedclip', label = _U('component_clip_extended'), hash = GetHashKey('COMPONENT_SIG_CLIP_02')},
			{name = 'sig_flashlight', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_SIG_FLSH_02')},
			{name = 'sig_suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_SIG_SUPP_01')},
			{name = 'sig_block_suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_SIG_SUPP_03')},
			{name = 'sig_scope', label = _U('component_scope'), hash = GetHashKey('COMPONENT_SIG_SCOPE_01')},
		}
	},
	{
		name = 'WEAPON_SR25',
		...
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'sr25_flashlight', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_SR25_FLSH_01')},
			{name = 'sr25_suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_SR25_SUPP_01')},
			{name = 'sr25_scope', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_SR25_SCOPE_08')}, --small acog
			{name = 'sr25_scope_optic1', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_SR25_SCOPE_02')}, --Optic
		}
	},
	{
		name = 'WEAPON_AKM',
		...
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'akm_suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AKM_SUPP_03')},
			{name = 'akm_scope', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AKM_SCOPE_05')}, --small acog
		}
	},
	{
		name = 'WEAPON_TOZ',
		...
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'toz_extended', label = _U('component_clip_extended'), hash = GetHashKey('COMPONENT_TOZ_CLIP_04')},
		}
	},
	{
		name = 'WEAPON_M4A1FM',
		...
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'm4a1_flashlight', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_M4A1FM_FLSH_06')}, --Standard flashlight
			{name = 'm4a1_kobra1', label = _U('component_scope'), hash = GetHashKey('COMPONENT_M4A1FM_SCOPE_03')}, --Kobra sight 1
			{name = 'm4a1_acog', label = _U('component_scope'), hash = GetHashKey('COMPONENT_M4A1FM_SCOPE_02')}, --Kobra sight 1
			{name = 'm4a1_extmag', label = _U('component_mag'), hash = GetHashKey('COMPONENT_M4A1FM_CLIP_03')}, -- Extended Mag
			{name = 'm4a1_drummag', label = _U('component_clip_drum'), hash = GetHashKey('COMPONENT_M4A1FM_CLIP_04')}, -- Drum Mag
			{name = 'm4a1_suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_M4A1FM_BARREL_04')}, --Suppressor
		}
	},
	--MPX
	{
		...
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'mpxhandguardlarge1', label = _U('component_handguard'), hash = GetHashKey('COMPONENT_MPX_HANDGUARD_04')}, -- Handguard large
			{name = 'mpxhandguardlarge2', label = _U('component_handguard'), hash = GetHashKey('COMPONENT_MPX_HANDGUARD_06')}, -- Handguard large
			{name = 'mpxstock1', label = _U('component_stock'), hash = GetHashKey('COMPONENT_MPX_STOCK_03')}, -- Drum Mag
			{name = 'mpxstock2', label = _U('component_stock'), hash = GetHashKey('COMPONENT_MPX_STOCK_07')}, -- Drum Mag
			{name = 'mpxextmag', label = _U('component_mag'), hash = GetHashKey('COMPONENT_MPX_CLIP_02')}, -- Drum Mag
			{name = 'mpxdrummag', label = _U('component_clip_drum'), hash = GetHashKey('COMPONENT_MPX_CLIP_03')}, -- Drum Mag
			{name = 'mpxkobra', label = _U('component_scope'), hash = GetHashKey('COMPONENT_MPX_SCOPE_04')}, --Kobra sight
			{name = 'mpxacog', label = _U('component_scope'), hash = GetHashKey('COMPONENT_MPX_SCOPE_06')}, --Acog sight
			{name = 'mpxsuppressorbarrel', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_MPX_BARREL_05')}, --Suppressor
			{name = 'mpxboxsuppressorbarrel', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_MPX_BARREL_06')}, --Box Suppressor
			{name = 'smg_flashlight', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_MPX_FLSH_02')}, --Flashlight
		}
	},
	--Scar17
	{
		...
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'scar_flashlight', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_SCAR_FLSH_04')},
			{name = 'scar_suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_SCAR_BARREL_08')},
			{name = 'scar_rds', label = _U('component_scope'), hash = GetHashKey('COMPONENT_SCAR_SCOPE_03')},
			{name = 'scar_kobra', label = _U('component_scope'), hash = GetHashKey('COMPONENT_SCAR_SCOPE_11')},
		}
	},
	--P90
	{
		...
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'p90rds', label = _U('component_scope'), hash = GetHashKey('COMPONENT_P90_SCOPE_05')},
			{name = 'p90kobra', label = _U('component_scope'), hash = GetHashKey('COMPONENT_P90_SCOPE_07')},
			{name = 'p90suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_P90_BARREL_02')},
			{name = 'p90flashlight', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_P90_FLSH_02')},
		}
	},
	--AR15
	{
		...
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'ar15-drum', label = _U('component_clip_drum'), hash = GetHashKey('COMPONENT_BEOWULF_CLIP_10')},
			{name = 'ar15-rds', label = _U('component_scope'), hash = GetHashKey('COMPONENT_BEOWULF_SCOPE_09')}, 
			{name = 'ar15-kobra', label = _U('component_scope'), hash = GetHashKey('COMPONENT_BEOWULF_SCOPE_06')}, 
			{name = 'ar15-vortex', label = _U('component_scope'), hash = GetHashKey('COMPONENT_BEOWULF_SCOPE_13')}, 
			{name = 'ar15-suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_BEOWULF_SUPP_03')}, 
		}
	},
	--M4A1 - PD Only
	{
	...
	--LESS LETHAL SHOTGUN
	{
		...
		label = _U('weapon_lesslethal'),
		ammo = {label = _U('ammo_shells'), hash = GetHashKey('AMMO_SHOTGUN')},
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'flashlight_lesslethal', label = _U('component_flashlight'), hash = GetHashKey('w_at_lesslethal_flsh')},
		}
	},
	--AKS74U
	{
		...
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'aks75-drum', label = _U('component_clip_drum'), hash = GetHashKey('COMPONENT_AKS74U_CLIP_09')},
			{name = 'aks75-suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AKS74U_MUZ_07')}, 
		}
	},
	--UMP
	{
		...
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'hkump-suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_UMP_SUPP_03')}, 
		}
	},
	--HANE Carbine - Used for AirSoft
	{
		name = 'WEAPON_PROTORIFLE',
		label = "Airsoft Rifle",
		ammo = {label = _U('ammo_rounds'), hash = GetHashKey('AMMO_RIFLE')},
		tints = Config.DefaultWeaponTints,
		components = {}
...

	{
		...
		components = {
			...
			{name = 'flashlight_pistol_MK2', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_PI_FLSH_02')},
			{name = 'suppressor_pistol_MK2', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_PI_SUPP_02')},
...

	{
		...
		components = {
			...
			{name = 'flashlight_combatpistol', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_PI_FLSH')},
			{name = 'suppressor_combatpistol', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_PI_SUPP')},
	...
	{name = 'WEAPON_DOUBLEACTION', label = _U('weapon_doubleaction'), components = {}, ammo = {label = _U('ammo_rounds'), hash = GetHashKey('AMMO_PISTOL')}},
	{
		...
		components = {
			...
			{name = 'flashlight_combatpistol', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_PI_FLSH')},
			{name = 'suppressor_combatpistol', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_PI_COMP_03')},
			{name = 'sig_scope', label = _U('component_scope'), hash = GetHashKey('COMPONENT_AT_SIGHTS')},
		}
	},

	{
		...
		components = {
			...
			{name = 'smg_extended', label = _U('component_clip_extended'), hash = GetHashKey('COMPONENT_SMG_CLIP_02')},
			{name = 'clip_drum', label = _U('component_clip_drum'), hash = GetHashKey('COMPONENT_SMG_CLIP_03')},
			{name = 'smg_flashlight', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH')},
			{name = 'smg_scope', label = _U('component_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_MACRO')},
			{name = 'smg_suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_PI_SUPP')},
...

	{
		...
		components = {
			...
			{name = 'microsmg_extendedmag', label = _U('component_clip_extended'), hash = GetHashKey('COMPONENT_MICROSMG_CLIP_02')},
			{name = 'flashlight', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_PI_FLSH')},
			{name = 'scope', label = _U('component_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_MACRO')},
			{name = 'microsmg_suppressor', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_AR_SUPP_02')},
...

	{
		...
		components = {
			...
			{name = 'smg_extended', label = _U('component_clip_extended'), hash = GetHashKey('COMPONENT_COMBATPDW_CLIP_02')},
			...
			{name = 'scope_pdw', label = _U('component_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_SMALL')}
		}
	},

	{
		...
		tints = Config.DefaultWeaponTints,
		components = {
			{name = 'flashlight_pumpshotgun', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH')},
			{name = 'suppressor_pumpshotgun', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_SR_SUPP')},
...

	{
		...
		components = {
			{name = 'flashlight_pumpshotgun', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH')},
			{name = 'suppressor_pumpshotgun', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_SR_SUPP_03')},
			{name = 'scope_pumpshotgunmk2', label = _U('component_scope'), hash = GetHashKey('COMPONENT_AT_SIGHTS')}
		}
	},
...

	{
		...
		components = {
			...
			{name = 'clip_extended_ak', label = _U('component_clip_extended'), hash = GetHashKey('COMPONENT_ASSAULTRIFLE_CLIP_02')},
			{name = 'clip_drum', label = _U('component_clip_drum'), hash = GetHashKey('COMPONENT_ASSAULTRIFLE_CLIP_03')},
			{name = 'flashlight_rifle', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH')},
			{name = 'scope_rifle', label = _U('component_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_MACRO')},
			{name = 'suppressor_ak', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_AR_SUPP_02')},
			{name = 'grip', label = _U('component_grip'), hash = GetHashKey('COMPONENT_AT_AR_AFGRIP')},
...

	{
		...
		components = {
			...
			{name = 'clip_extended_ak', label = _U('component_clip_extended'), hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MK2_CLIP_02')},
			{name = 'flashlight_rifle', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH')},
			{name = 'scope_rifle', label = _U('component_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_MACRO_MK2')},
			{name = 'suppressor_ak', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_AR_SUPP_02')},
			{name = 'grip', label = _U('component_grip'), hash = GetHashKey('COMPONENT_AT_AR_AFGRIP_02')},
			{name = 'luxary_finish', label = _U('component_luxary_finish'), hash = GetHashKey('COMPONENT_ASSAULTRIFLE_MK2_CAMO')}
		}
	},

	{
		...
		components = {
			...
			{name = 'flashlight_ar', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH')},
			{name = 'scope_rifle', label = _U('component_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_MEDIUM')},
			{name = 'suppressor_ar', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_AR_SUPP')},
			{name = 'grip', label = _U('component_grip'), hash = GetHashKey('COMPONENT_AT_AR_AFGRIP')},
...

	{
		...
		components = {
			...
			{name = 'flashlight_ar', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH')},
			{name = 'riflemk2_scope', label = _U('component_scope'), hash = GetHashKey('COMPONENT_AT_SIGHTS')},
			{name = 'suppressor_ar', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_AR_SUPP_02')},
			{name = 'grip', label = _U('component_grip'), hash = GetHashKey('COMPONENT_AT_AR_AFGRIP_02')},
		}
	},
...

	{
		...
		components = {
			...
			{name = 'flashlight_ar', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH')},
			{name = 'scope_rifle', label = _U('component_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_SMALL')},
			{name = 'suppressor_ar', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_AR_SUPP')},
		}
	},

	{
		...
		components = {
			...
			{name = 'flashlight_ar', label = _U('component_flashlight'), hash = GetHashKey('COMPONENT_AT_AR_FLSH')},
			{name = 'scope_rifle', label = _U('component_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_MEDIUM')},
			{name = 'suppressor_special', label = _U('component_suppressor'), hash = GetHashKey('COMPONENT_AT_AR_SUPP_02')},
			{name = 'grip', label = _U('component_grip'), hash = GetHashKey('COMPONENT_AT_AR_AFGRIP')},
	...
	{name = 'WEAPON_HK516',	label = _U('weapon_hk516'), tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = GetHashKey('AMMO_RIFLE')}},
	...
	{name = 'WEAPON_EMPLAUNCHER', label = _U('weapon_emplauncher'), tints = Config.DefaultWeaponTints, components = {}},
	...
	{name = 'WEAPON_POCKETLIGHT', label = _U('weapon_pocketlight'), components = {}},
	...
	{name = 'WEAPON_COLBATON', label = _U('weapon_colbaton'), components = {}},
	...
	{name = 'WEAPON_SMOKEGR', label = _U('weapon_smokegr'), components = {}, ammo = {label = _U('ammo_bzgas'), hash = GetHashKey('AMMO_BZGAS')}},
	{name = 'WEAPON_FLASHBANG', label = _U('weapon_flashbang'), components = {}, ammo = {label = _U('ammo_bzgas'), hash = GetHashKey('AMMO_BZGAS')}}
}
